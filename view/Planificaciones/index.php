...
?>
	...
	<head lang="en">
		...
		<title>CET Nº 13::Carga Planificaciones</title>
	</head>
	...
	<body class="with-side-menu">
			...
			<div class="container-fluid">
				...
				<header class="section-header">
					<div class="tbl">
						<div class="tbl-row">
							<div class="tbl-cell">
								<h3>Carga Planificaciones</h3>
								<ol class="breadcrumb breadcrumb-simple">
									<li><a href="#">Home</a></li>
									<li class="active">Carga Planificaciones</li>
								</ol>
							</div>
						</div>
					</div>
				...
				<div class="box-typical box-typical-padding">
					...
					<div class="row">
						<form method="POST" id="planificacion_form">
		...
		<script type="text/javascript" src="planificaciones.js"></script>
	</body>
