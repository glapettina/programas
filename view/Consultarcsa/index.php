...
?>
	...
	<head lang="en">
		...
		<title>CET Nº 13::Programas C.S. Alimentación</title>
	</head>
	...
	<body class="with-side-menu">
			...
			<div class="container-fluid">
				<header class="section-header">
					<div class="tbl">
						<div class="tbl-row">
							<div class="tbl-cell">
								<h3>Programas Ciclo Superior - Alimentación</h3>
								<ol class="breadcrumb breadcrumb-simple">
									<li><a href="#">Home</a></li>
									<li class="active">Programas Ciclo Superior - Alimentación</li>
								</ol>
							</div>
						</div>
					</div>
		...
		<script type="text/javascript" src="consultarcsa.js"></script>
	</body>
