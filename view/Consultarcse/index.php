...
?>
	...
	<head lang="en">
		...
		<title>CET Nº 13::Programas C.S. Electro</title>
	</head>
	...
	<body class="with-side-menu">
			...
			<div class="container-fluid">
				<header class="section-header">
					<div class="tbl">
						<div class="tbl-row">
							<div class="tbl-cell">
								<h3>Programas Ciclo Superior - Electromecánica</h3>
								<ol class="breadcrumb breadcrumb-simple">
									<li><a href="#">Home</a></li>
									<li class="active">Programas Ciclo Superior - Electromecánica</li>
								</ol>
							</div>
						</div>
					</div>
		...
		<script type="text/javascript" src="consultarcse.js"></script>
	</body>
