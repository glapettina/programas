...
?>
	...
	<head lang="en">
		...
		<title>CET Nº 13::Programas Taller Ciclo Básico</title>
	</head>
	...
	<body class="with-side-menu">
			...
			<div class="container-fluid">
				<header class="section-header">
					<div class="tbl">
						<div class="tbl-row">
							<div class="tbl-cell">
								<h3>Programas Taller Ciclo Básico</h3>
								<ol class="breadcrumb breadcrumb-simple">
									<li><a href="#">Home</a></li>
									<li class="active">Programas Taller Ciclo Básico</li>
								</ol>
							</div>
						</div>
					</div>
		...
		<script type="text/javascript" src="consultartallercb.js"></script>
	</body>
