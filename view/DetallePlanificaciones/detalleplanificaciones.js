...
$(document).ready(function () {
  var planificacion_id = getUrlParameter("ID");

  listarDetalle(planificacion_id);
  ...
  tabla=$('#documentos_data').dataTable({
    ...
    "ajax":{
        url: '../../controller/documento.php?op=listarplanificacion',
        type : "post",
...
function listarDetalle(planificacion_id) {


  $.post(
    "../../controller/materia.php?op=mostrarplanificacion",
