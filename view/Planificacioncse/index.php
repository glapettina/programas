...
?>
	...
	<head lang="en">
		...
		<title>CET Nº 13::Planificaciones Ciclo Superior Electro</title>
	</head>
	...
	<body class="with-side-menu">
			...
			<div class="container-fluid">
				<header class="section-header">
					<div class="tbl">
						<div class="tbl-row">
							<div class="tbl-cell">
								<h3>Planificaciones Ciclo Superior Electro</h3>
								<ol class="breadcrumb breadcrumb-simple">
									<li><a href="#">Home</a></li>
									<li class="active">Planificaciones Ciclo Superior Electro</li>
								</ol>
							</div>
						</div>
					</div>
		...
		<script type="text/javascript" src="planificacioncse.js"></script>
	</body>
