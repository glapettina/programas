...
?>
	...
	<head lang="en">
		...
		<title>CET Nº 13::Planificaciones Ciclo Básico</title>
	</head>
	...
	<body class="with-side-menu">
			...
			<div class="container-fluid">
				<header class="section-header">
					<div class="tbl">
						<div class="tbl-row">
							<div class="tbl-cell">
								<h3>Planificaciones Ciclo Básico</h3>
								<ol class="breadcrumb breadcrumb-simple">
									<li><a href="#">Home</a></li>
									<li class="active">Planificaciones Ciclo Básico</li>
								</ol>
							</div>
						</div>
					</div>
		...
		<script type="text/javascript" src="planificacioncb.js"></script>
	</body>
