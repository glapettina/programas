...
?>
	...
	<head lang="en">
		...
		<title>CET Nº 13::Planificaciones Ciclo Superior Alimentación</title>
	</head>
	...
	<body class="with-side-menu">
			...
			<div class="container-fluid">
				<header class="section-header">
					<div class="tbl">
						<div class="tbl-row">
							<div class="tbl-cell">
								<h3>Planificaciones Ciclo Superior Alimentación</h3>
								<ol class="breadcrumb breadcrumb-simple">
									<li><a href="#">Home</a></li>
									<li class="active">Planificaciones Ciclo Superior Alimentación</li>
								</ol>
							</div>
						</div>
					</div>
				...
				<div class="box-typical box-typical-padding">
					...
					<div class="box-typical box-typical-padding" id="table">
						...
						<table id="planificacion_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
							<input type="hidden" id="planificacion_id" name="planificacion_id">
		...
		<script type="text/javascript" src="planificacioncsa.js"></script>
	</body>
